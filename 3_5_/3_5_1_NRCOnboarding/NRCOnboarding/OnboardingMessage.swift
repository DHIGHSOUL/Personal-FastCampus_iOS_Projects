...
extension OnboardingMessage {
    static let messages: [OnboardingMessage] = [
        ...
        OnboardingMessage(imageName: "img_nike_logo_red", title: "START RIGHT NOW", description: "Nike run gives you many inspires and passions. You can use all of them and please get out your freedom into world.")
    ]
